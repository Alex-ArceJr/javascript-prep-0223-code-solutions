...
1. Ask the difference between a function statement and function declaration?
2. Ask about the increment(++) operator
3. Ask about the Remainder(%) operator
4. Ask about the string to string comparison
